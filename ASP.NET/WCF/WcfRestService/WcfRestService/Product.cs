...
namespace WcfRestService
{
    ...
    public partial class Products
    {
        ...
        private Products() { }      //private constructor
        ...
        private List<Product> products = new List<Product>()
        {
            ...
            new Product() { ProductId = 4, Name = "Product 4", CategoryName="Category 1", Price=11},
            new Product() { ProductId = 5, Name = "Product 5", CategoryName="Category 3", Price=9},
        };
    }
}